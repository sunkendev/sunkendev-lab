...
- legal-research project has no v00 stubs — created before v5, needs backfill
- pre-commit.py MASTER-PROMPT.md write protection not yet implemented — block commits to MASTER-PROMPT.md from non-ai-library-system projects
STATE:
- MASTER-PROMPT.md v23: two new behaviour rules added — no-out-of-band-fix kernel rule and ai-library-system-only MASTER-PROMPT.md write rule
- Library designated open source; ships with ai-library-system intact and full history
- Next: legal-research v00 backfill, pre-commit MASTER-PROMPT.md write protection, GitHub remote setup
