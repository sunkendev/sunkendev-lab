...
- Artifact wrapper schema: LABEL, VERSION MATCH, EXTENSION MATCH, NON-EMPTY BODY — label check removed from pre-commit hook; artifact file contains deliverable content only
...
- Artifact label line in saved artifact file — artifact contains deliverable content only
...
STATE:
- MASTER-PROMPT.md at v11 — unchanged from v10, version incremented for triplet sync
- checkpoint.py deployed and operational, three post-v10 fixes committed
- Second checkpoint.py live test pending
