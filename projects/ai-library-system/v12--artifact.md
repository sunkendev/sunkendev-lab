...
0. Download v[NN]-checkpoint.txt and move it outside the library folder
1. Run: python3 code/checkpoint.py [slug] [NN] ~/Desktop/v[NN]-checkpoint.txt
2. Verify dry-run output, then run with --write
3. If the artifact is MASTER-PROMPT.md, copy v[NN]--artifact.md to MASTER-PROMPT.md at library root
4. Run: git add .
