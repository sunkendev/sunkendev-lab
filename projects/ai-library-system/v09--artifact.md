...
1. Print the full artifact as raw output in a code block
   ...
   - Body is non-empty
   - If the artifact contains fenced code blocks, use four backticks
     as the outer fence to prevent fence collision
...
After all four blocks print, tell the user exactly:
