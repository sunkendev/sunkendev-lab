...
STATE:
- MASTER-PROMPT.md v26: unchanged from v25; version incremented for triplet sync
- checkpoint.py updated: write_checkpoint_log() appends one line to logs/checkpoint-runs.log after every --write run
- .gitignore updated: logs/* + !logs/checkpoint-runs.log; checkpoint-runs.log now tracked in git
